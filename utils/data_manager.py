...
from utils.data import iCIFAR10, iCIFAR100, iImageNet100, iImageNet_R, iImageNet1000, iCUB200,iImageNet_A,iPets,iFood101,iFlower102,iCars,iTiny_ImageNet
...
class DataManager(object):
    ...
    def get_class_name(self, dataset, indice):
        ...
        if dataset == 'cifar100':
            ...
            prompt = "A good photo of {}."
            name = "./data/imagenet100/imagenet100_label2class.json"
        elif dataset == 'food':
            prompt = "A photo of {}, food."
            name = "./data/food/food_label2class.json"
        elif dataset == 'flower':
            prompt = "A photo of {}, a kind of flower."
            name = "./data/flower/flower_label2class.json"
        elif dataset == 'pets': prompt = "A photo of {}, a kind of pet."
        elif dataset == 'cars':
            prompt = "A photo of {}, a kind of car."
            name = "./data/cars/cars_label2class.json"
...
def _get_idata(dataset_name,preprocess=None):
    ...
    elif name == "imagenet1000": return iImageNet1000()
